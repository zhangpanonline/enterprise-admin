...
<script>
import uChartsMp from '@/uni_modules/qiun-data-charts/u-charts/u-charts.js';
import cfu from '@/uni_modules/qiun-data-charts/u-charts/config-ucharts.js';
// #ifdef APP-VUE || H5
import cfe from '@/uni_modules/qiun-data-charts/u-charts/config-echarts.js';
// #endif
...
import uChartsRD from '@/uni_modules/qiun-data-charts/u-charts/u-charts.js';
import cfu from '@/uni_modules/qiun-data-charts/u-charts/config-ucharts.js';
import cfe from '@/uni_modules/qiun-data-charts/u-charts/config-echarts.js';
  ...
  methods: {
    ...
    ecinit(newVal, oldVal, owner, instance){
      ...
      if (typeof window.echarts === 'object') {
        ...
        // TODO 微信小程序没有dom，为了打包体积，这里移除了微信小程序的echarts，如果需要，请自行添加
        // script.src = rooturl + 'static/echarts.min.js';
        // #endif
