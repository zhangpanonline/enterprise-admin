...
function drawToolTip(
  ...
  if (textList[0].text.split('/')[0] === '自定义') {
    let newTextList = [
      { text: textList[0].text.split('//')[1], color: textList[0].color },
      { text: textList[0].text.split('//')[2], color: textList[0].color },
      { text: textList[0].text.split('//')[3], color: textList[0].color },
    ];
