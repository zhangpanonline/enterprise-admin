  ...
  <div class="report">
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="colSpan">
          <el-form-item label="法人/负责人手机号" prop="legarPersonPhone">
            <el-input
              v-model="form.legarPersonPhone"
              placeholder="请输入法人/负责人手机号"
            />
          </el-form-item>
        </el-col>
        <el-col :span="colSpan">
      ...
      >
        ...
        <el-col :span="colSpan">
          <el-form-item
            ...
            :rules="[{ required: !!form.bankruptCreditorAgent[0]['agentType'], message: '请输入代理人电话！' }, { validator: telphoneValid }]">
            <el-input
...
export default {
  ...
  setup() {
    ...
    const rules = {
      ...
      legarPersonPhone: [
        { required: true, message: '请输入法人/负责人手机号！', trigger: 'blur' },
      ],
      creditorOpeningBank: [
      ...
      address: [
        { required: true, message: '请输入联系地址号！', trigger: 'blur' },
      ],
      creditorCreateDate: [
      ...
      factAndReason: [
        { required: true, message: '请输入债权发生的基本事实和理由！', trigger: 'blur' },
      ],
    }
    return { rules, idCardValid, telphoneValid }
  },
  data() {
    return {
      COUNTRY,
