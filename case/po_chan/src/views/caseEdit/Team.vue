  ...
  <div style="overflow: auto; height: 100%" class="all-con">
    ...
    >
      <el-row>
        ...
        <el-col v-if="isBuild" :span="2" class="right">
...
export default {
  ...
  setup() {
    ...
    return { appStore, comRules, userRules, userPhoto }
  },
  data() {
    return {
      hasTree: 1,
  ...
  mounted() {
    this.id = this.case.projectId
    this.newData.projectId = this.case.projectId
    this.newData.companyId = this.case.companyId
    this.projectType = this.case.projectType
    this.getTreeData()
    this.getComListData(1)
    this.getCompanyType()
