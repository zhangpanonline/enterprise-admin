...
export default defineManifest({
  ...
  action: {
    ...
    default_popup: 'index.html', // 点击图标时弹出的页面
  },
  /**
  ...
  content_scripts: [
    {
      ...
      run_at: "document_end", // 决定脚本注入的时机：document_start => 在文档开始加载时注入（DOM 未生成前）,document_end => 在 DOM 加载完成后注入, document_idle => 在 DOM 加载完成后，延迟到页面空闲时注入
